...
namespace Parameters
{
  ...
  extern const unsigned long int    timeDrogueChuteActive; // The drogue chute is activated by timeDrogueChuteActive milliseconds. After that, the signal is turned off.
  extern const unsigned long int      timeParachuteActive; // The drogue chute is activated by timeParachuteActive milliseconds. After that, the signal is turned off.
